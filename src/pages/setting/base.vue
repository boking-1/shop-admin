            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="注册与访问" name="first">
                    ...
                    <el-form-item label="注册类型">
                        <el-radio-group v-model="form.reg_method">
                            <el-radio value="username" border>
                                普通注册
                            </el-radio>
                            <el-radio value="phone" border>
                                手机注册
                            </el-radio>
                        </el-radio-group>
                    </el-form-item>
                    ...
                    <el-form-item label="密码最小长度">
                        <el-input v-model="form.password_min" placeholder="密码最小长度" type="number"
                            style="width: 30%;"></el-input>
                    </el-form-item>

                    <el-form-item label="强制密码复杂度">
                        <el-checkbox-group v-model="form.password_encrypt">
                            <el-checkbox value="0" border>
                                数字
                            </el-checkbox>
                ...
                <el-tab-pane label="上传设置" name="second">
                    ...
                    <el-form-item label="Bucket">
                        <el-input v-model="form.upload_config.Bucket" placeholder="Bucket"
                            style="width: 30%;"></el-input>
                    </el-form-item>

                    <el-form-item label="ACCESS_KEY">
                        <el-input v-model="form.upload_config.ACCESS_KEY" placeholder="ACCESS_KEY"
                            style="width: 30%;"></el-input>
                    </el-form-item>

                    <el-form-item label="SECRET_KEY">
                        <el-input v-model="form.upload_config.SECRET_KEY" placeholder="SECRET_KEY"
                            style="width: 30%;"></el-input>
                    </el-form-item>

                    <el-form-item label="空间域名">
                        <el-input v-model="form.upload_config.http" placeholder="空间域名" style="width: 30%;"></el-input>
                        <small class="text-gray-500 flex ml-1">请补全http://或https://</small>
                    </el-form-item>
                </el-tab-pane>
                <el-tab-pane label="API安全" name="third">
                    <el-form-item label="是否开启API安全">
                        ...
                        <small class="text-gray-500 flex ml-1">api安全开启之后调用前端api需要传输签名串</small>

                    </el-form-item>

                    <el-form-item label="密钥">
                        <el-input v-model="form.api_secret" placeholder="密钥" style="width: 30%;"></el-input>
                        <small
                            class="text-gray-500 flex mt-1">密钥设置关系系统中api调用传输签名串的编码规则，以及会员token解析，请慎重设置，注意这只之后对应会员要求重新登录获取token
                        </small>
                    </el-form-item>
                </el-tab-pane>
            </el-tabs>
