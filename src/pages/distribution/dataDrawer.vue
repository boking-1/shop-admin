<template>
    <el-drawer :title="drawerTitle" v-model="dialogVisible" direction="rtl" size="70%" :destroy-on-close="true"
        :show-close="true" :wrapperClosable="true">
        <!-- 搜索 -->
        <el-form :model="searchForm" label-width="80px" size="small">
            <el-form-item label="时间选择">
                <el-radio-group v-model="searchForm.type" @change="">
            ...
            <el-form-item label="用户类型">
                <el-radio-group v-model="searchForm.level" @change="">
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            <template v-if="props.type == 'user'">
                ...
                <el-table-column label="推广数" prop="share_num" />
                <el-table-column label="推广订单数" prop="share_order_num" />
                <el-table-column label="绑定时间" prop="create_time" />
            </template>
            <template v-else>
